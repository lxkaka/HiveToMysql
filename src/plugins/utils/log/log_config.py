...
REMOTE_HANDLERS = {
    ...
    "oss": {
        "task": {
            "class": "plugins.utils.log.oss_task_handler.OSSTaskHandler",
            "formatter": "airflow",
            "base_log_folder": os.path.expanduser(BASE_LOG_FOLDER),
...
elif REMOTE_LOGGING and REMOTE_BASE_LOG_FOLDER.startswith("oss://"):
    LOGGING_CONFIG["handlers"].update(REMOTE_HANDLERS["oss"])
